...
if ($_POST){
    ...
    if(empty($nama_kelas)){
        ...
        echo "<script>alert('angkatan tidk boleh kosong');location.href='tambah_kelas.php';</script>";
    } else {
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into kelas1 (nama_kelas,kelompok,angkatan) value ('".$nama_kelas."','".$kelompok."','".$angkatan."')");
        if ($insert){
