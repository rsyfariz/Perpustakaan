...
if($_GET['id']){
    ...
    $cek_terlambat=mysqli_query($conn, "select * from peminjaman_buku1 where id_peminjaman_buku = '".$id_peminjaman_buku."'");
...
mysqli_query($conn, "insert into pengembalian_buku1 (id_peminjaman_buku, tanggal_pengembalian,denda)value('".$id_peminjaman_buku."','".date('Y-m-d')."','".$denda."')");
